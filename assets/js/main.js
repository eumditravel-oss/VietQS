...
const i18n = {
  ko: {
    ...
    business: {
      eyebrow: "BUSINESS",
      title: "견적 실무 전반을 체계적으로 수행합니다.",
      body:
        "CONCOST의 견적 경험과 Viet QS의 수행 역량을 바탕으로 도면 검토, 수량산출, 원가계산, BOQ/WBS 작성, 설계변경 정산, 해외·FED, 구조 BIM 연계 업무를 지원합니다.",
    ...
    services: {
      ...
      change: {
        ...
        heroTitle: "설계변경 및 공사비 정산",
        heroCopy:
          "당초 도면과 변경 도면을 비교하여 수량을 산출하고, 적용 단가를 반영해 설계변경 및 준공 정산에 필요한 공사비 내역서를 작성합니다.",
        panelTitle: "설계변경 정산",
